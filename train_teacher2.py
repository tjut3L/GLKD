...
def parse_option():
    ...
    parser.add_argument('--lr_decay_epochs', type=str, default='60,120,150,180',
    ...
    parser.add_argument('--dataset', type=str, default='tiny-imagenet', choices=['cifar100', 'tiny-imagenet'],
                        help='dataset')

    parser.add_argument('--gpu', type=str, default='7', help='id(s) for CUDA_VISIBLE_DEVICES')
    ...
    if hostname.startswith('visiongpu'):
        ...
        opt.model_path = './save/my/models'
        opt.tb_path = './save/my/tensorboard'
