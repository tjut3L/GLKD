...
target_folder = '/data/tjut_jjl/dataset/tiny-imagenet-200/val/'

val_dict = {}

# /data/tjut_jjl/dataset/tiny-imagenet-200/val/val_annotations.txt
with open('/data/tjut_jjl/dataset/tiny-imagenet-200/val/val_annotations.txt', 'r') as f:
    for line in f.readlines():
        split_line = line.split('\t')
        val_dict[split_line[0]] = split_line[1]

paths = glob.glob('/data/tjut_jjl/dataset/tiny-imagenet-200/val/images/*')
for path in paths:
    file = path.split('/')[-1]
...
rmdir('/data/tjut_jjl/dataset/tiny-imagenet-200/val/images')
